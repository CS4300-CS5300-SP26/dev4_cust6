...
class SubmissionDetailsViewTests(TestCase):
    ...
    def test_valid_submission_redirects_to_confirmation(self):
        ...
        self.assertRedirects(
            response, reverse("submission:confirmation", args=[submission.pk])
        )
    ...
    def test_invalid_inputs(
        ...
        self.assertFalse(
            Submission.objects.filter(card_name=card_name, address=address).exists()
        )
...
class SubmissionConfirmationViewTests(TestCase):
    ...
    def test_confirmation_404_for_invalid_pk(self):
        ...
        response = self.client.get(reverse("submission:confirmation", args=[9999]))
